...
const JobCard = ({
  ...
  return <Card className={`hover:shadow-md transition-shadow border border-gray-100 ${job.featured ? 'border-primary/30' : ''}`}>
      <CardContent className="p-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:flex-col lg:flex-row self-end md:self-center">
            ...
            <Button className="gap-1 bg-[#3054A5] hover:bg-[#264785]" asChild>
