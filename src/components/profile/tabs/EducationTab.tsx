...
const EducationTab: React.FC<EducationTabProps> = ({
  ...
  return <>
      ...
      <div className="space-y-6">
        {education && education.length > 0 ? education.map((edu, index) => <div key={edu.id || index} className="relative border rounded-lg p-6 bg-white shadow-sm">
              ...
              field
                  ...
                  <h4 className="text-black text-base font-semibold">{edu.degree || "Degree not specified"}</h4>
