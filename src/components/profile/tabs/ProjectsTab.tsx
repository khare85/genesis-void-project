...
const ProjectsTab: React.FC<ProjectsTabProps> = ({
  ...
  return <>
      ...
      <div className="grid gap-5">
        {projects && projects.length > 0 ? projects.map((project, index) => <Card key={project.id || index} className="overflow-hidden">
              ...
              field
                  ...
                  {project.link && <CardFooter className="bg-blue-50">
            ...
            </Card>) : <div className="text-center p-8 border border-dashed rounded-md">
