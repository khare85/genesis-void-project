...
const planFormSchema = z.object({
  ...
  max_jobs: z.coerce.number().int().positive({ message: "Max jobs must be a positive integer." }),
  max_users: z.coerce.number().int().positive({ message: "Max users must be a positive integer." }),
  ai_credits: z.coerce.number().int().nonnegative({ message: "AI credits must be a positive integer." }),
