  ...
  return <SidebarProvider defaultOpen={true}>
      <div className="flex h-screen overflow-hidden w-full">
        <Sidebar>
          ...
          <SidebarFooter className="bg-blue-950 rounded-none">
            {shouldShowAICredits && <div className="m-4">
                <div className="bg-gradient-to-br from-blue-50/90 to-blue-100/50 border border-blue-100/80 p-4 shadow-sm rounded-lg bg-sky-50">
