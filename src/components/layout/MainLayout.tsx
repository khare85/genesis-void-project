      ...
      <div className="flex h-screen overflow-hidden w-full">
        <Sidebar className="border-r border-slate-200/20">
          ...
          <SidebarFooter className="bg-gradient-to-b from-blue-950 to-blue-900 rounded-none">
            {shouldShowAICredits && (
              <div className="m-4">
                <div className="ats-card-3d p-4 bg-gradient-to-br from-blue-600/10 to-blue-900/5 backdrop-blur-sm border border-white/10">
                  ...
                  <div className="mb-3 h-2 rounded-full bg-blue-900/30">
                    <div 
                      ...
                      className="h-full rounded-full transition-all duration-300 ease-in-out bg-blue-400"
                    ></div>
                  </div>
                  {isLoading ? (
                    <p className="text-xs text-blue-200">Loading credits...</p>
                  ) : (
                ...
                <div className="flex md:w-60 lg:w-72">
                  <div className="relative w-full">
                    <input 
                      type="search" 
                      placeholder="Search..." 
                      className="w-full rounded-lg border border-slate-200 py-2 px-3 text-sm outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-slate-50"
                    />
                  </div>
                </div>
              </div>
