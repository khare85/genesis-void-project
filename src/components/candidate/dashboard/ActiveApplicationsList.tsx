...
const ActiveApplicationsList: React.FC<ActiveApplicationsListProps> = ({
  ...
  return <div className="space-y-4 bg-white">
      {applications.map((job, i) => <Card key={job.id || i} className="flex items-center justify-between p-4 border-gray-100 hover:border-primary transition-colors shadow-sm bg-white rounded-none">
