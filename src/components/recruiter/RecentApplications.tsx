  ...
  return <Card className="col-span-2 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.2)] transition-shadow duration-300 bg-white rounded-2xl border-0 transform transition-all hover:-translate-y-1">
      <div className="p-6 bg-transparent rounded-full">
        ...
        <Tabs defaultValue="waiting">
          <TabsList className="mb-4 bg-blue-900">
          ...
          <TabsContent value="waiting" className="p-0 border-0">
            {isLoading ? <div className="space-y-4">
                ...
                {waitingReview.map(candidate => <div key={candidate.id} className="flex items-center justify-between p-3 shadow-md hover:shadow-lg hover:bg-muted hover:bg-opacity-30 transition-all py-[5px] rounded-2xl">
