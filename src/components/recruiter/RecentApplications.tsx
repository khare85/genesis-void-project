        ...
        <Tabs defaultValue="waiting">
          ...
          <TabsContent value="waiting" className="p-0 border-0">
            {isLoading ? <div className="space-y-4">
                ...
                {waitingReview.map(candidate => <div key={candidate.id} className="flex items-center justify-between p-3 shadow-md hover:shadow-lg hover:bg-muted hover:bg-opacity-30 transition-all rounded-lg py-[5px]">
